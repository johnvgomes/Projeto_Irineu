...
<html>
    ...
    <link href="../css/amigos.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Amigos</h2>
     </div>
     <div class="amigos_main">
     
     <div class="img_do_amigos">
     <img class="img_amigos" src="../imagem/castilho_usuario.jpg">
     </div>
     
       <div id="titulo_do_amigos">
        <h2 class="titulo_do_amigos_text"> Gustavo Castilho <h2>
       </div>
       <div id="caixa_descricao_do_amigos"><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id="texto_descricao_tipo">
       <h2 class="descricao_tipo_text"> Pessoa <h2>
       </div>
        <div id="texto_descricao_local">
       <h2 class="descricao_local_text"> Etec Martinho di Ciero...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)99283-6754<h2>
       </div>
     ...
     <div class="img_do_amigos">
     <img class="img_amigos" src="../imagem/giovana_usuario.jpg">
     </div>
     
       <div id="titulo_do_amigos">
        <h2 class="titulo_do_amigos_text"> Giovanna Januario <h2>
       </div>
       <div id="caixa_descricao_do_amigos"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_local_text"> Etec Martinho di Ciero...  <h2>
        ...
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)99282-9750<h2>
       </div>
     ...
     <div class="img_do_amigos">
     <img class="img_amigos" src="../imagem/logo.png">
     </div>
     
       <div id="titulo_do_amigos">
        <h2 class="titulo_do_amigos_text"> Bar Kara O Que? <h2>
       </div>
       <div id="caixa_descricao_do_amigos"><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id="texto_descricao_tipo">
       <h2 class="descricao_tipo_text"> Empresa <h2>
       </div>
        <div id="texto_descricao_local">
       <h2 class="descricao_local_text"> Bar kara o que?...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)99213-0984<h2>
       </div>
     ...
     <div class="img_do_amigos">
     <img class="img_amigos" src="../imagem/vinicius_usuario.jpeg">
     </div>
     
       <div id="titulo_do_amigos">
        <h2 class="titulo_do_amigos_text"> Vinicius Delpino<h2>
       </div>
       <div id="caixa_descricao_do_amigos"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_local_text"> Etec Martinho di Ciero...  <h2>
        ...
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)9283-6754<h2>
       </div>
