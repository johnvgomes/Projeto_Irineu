...
class Musicas {
    ...
    function __construct($id = "", $nome = "", $descricao_musica = "", $telefone = "", $logomarca = "", $temp_logo = "") {
        $this->id = $id;
        $this->nome = $nome;
        $this->descricao_local = $descricao_musica;
    ...
    public function getDescricao_musica() {
        return $this->descricao_musica;
    }
    ...
    public function setDescricao_musica($descricao_musica) {
        $this->descricao_musica = $descricao_musica;
    }
    ...
    public function salvar() {
        try {
            ...
            @$sqlprep->bindParam(2, $this->getDescricao_musica(), PDO::PARAM_STR);
            ...
            echo "Erro ao cadastrar empresa musical "
            . $exc->getMessage();
        }
    }
    ...
    public function editar() {
      ...
      public function consultar() {
        try {
            ...
            while ($vetor = $sqlprep->fetch(PDO::FETCH_NUM)) {
                echo "<article>
                    $vetor[0]<br>
                    Empresa musical: $vetor[1]<br>
                    Descrição: $vetor[2]<br>
                    Telefone: $vetor[3]<br>
                    <a href='../foto_musica/$vetor[4]' download>
                        Confira a o foto da empresa musical                               
                     <a href='?p=Musicas/excluir&id=$vetor[0]' title='Exclusão de local'>
                        <img src='../imagem/icone_deletar.png' alt='Excluir'>
                    </a> 
                    <a href='?p=Musicas/editar&id=$vetor[0]'
                        title='Editar empresa musical'>
     ...
     public function excluir(){
             try{
                 ...
                 $this->ct->excluirArquivo("../foto_musica/".$registro[4]);
             ...
             if ($sqlprep->execute() == 1){
                 ...
                 echo "Erro ao excluir empresa musical"
                 . $exc->getMessage();
 ...
 public function carregar(){
        try {
            ...
            echo "Erro ao carregar empresa musical".$exc->getTraceAsString();
        }
        }
    ...
    public function carregarSelect() {
        try {
           ...
           $sqlprep = $this->con->query($sql);
            ...
            echo "Erro ao consultar empresa musical "
            . $exc->getMessage();
        }
    }
