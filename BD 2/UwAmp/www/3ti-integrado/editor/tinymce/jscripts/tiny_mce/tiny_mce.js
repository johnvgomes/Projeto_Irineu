(function(e) {
    ...
    var c = {majorVersion: "3", minorVersion: "5b3", releaseDate: "2012-03-29", _init: function() {
...
tinymce.util.Quirks = function(d) {
    ...
    function B() {
        function C(F) {
            ...
            E.appendChild(G);
            return A.serializer.serialize(E, {format: "html"})
        }
        function D(E) {
            var G = C(E);
            var H = o.createRng();
...
(function(f) {
    ...
    f.html.Schema = function(B) {
            ...
            if (M) {
                ...
                for (L = 0, H = M.length; L < H; L++) {
                    ...
                    if (G) {
                        ...
                        P = {};
                        K = [];
                        J = {attributes: P, attributesOrder: K};
                        if (X === "#") {
                            J.paddEmpty = true
                        }
                        if (X === "-") {
                                ...
                                if (G) {
                                    ...
                                    if (X) {
                                        if (X === "=") {
                                            ...
                                            J.attributesDefault.push({name: Z, value: U});
                                            V.defaultValue = U
                                        }
                                        if (X === ":") {
                                            J.attributesForced = J.attributesForced || [];
                                            J.attributesForced.push({name: Z, value: U});
                                            V.forcedValue = U
                                        }
                                        if (X === "<") {
                                            V.validValues = e(U, "?")
        ...
        if (!B.valid_elements) {
            g(z, function(G, F) {
                s[F] = {attributes: G.attributes, attributesOrder: G.attributesOrder};
                k[F] = G.children
            });
            if (B.schema != "html5") {
    ...
    a.html.SaxParser = function(c, e) {
        ...
        b.parse = function(F) {
            ...
            function p(V, U, Z, Y, X) {
                ...
                O.map[U] = Z;
                O.push({name: U, value: Z})
            }
            l = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g");
            E = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:\\.|[^\"])*)\")|(?:\'((?:\\.|[^\'])*)\')|([^>\s]+)))?/g;
            L = {script: /<\/script[^>]*>/gi, style: /<\/style[^>]*>/gi, noscript: /<\/noscript[^>]*>/gi};
...
(function(b) {
    ...
    b.html.DomParser = function(g, h) {
        ...
        f.parse = function(x, m) {
            ...
            n = new b.html.SaxParser({validate: z, fix_self_closing: !z, cdata: function(l) {
...
(function() {
    ...
    var d = function(D, e, G, H) {
        ...
        if (E.length > 1 && j.exec(D)) {
            ...
            if (e) {
                K = H ? {expr: E.pop(), set: l(H)} : d.find(E.pop(), E.length === 1 && (E[0] === "~" || E[0] === "+") && e.parentNode ? e.parentNode : e, B);
    ...
    var k = d.selectors = {order: ["ID", "NAME", "TAG"], match: {ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/, NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/, ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/, TAG: /^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/, CHILD: /:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/, POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/, PSEUDO: /:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {href: function(e) {
            ...
            }}, preFilter: {CLASS: function(B, z, A, e, E, F) {
                B = " " + B[1].replace(q, "") + " ";
                if (F) {
                    return B
                }
                ...
                return e[3] - 0 === z
            }}, filter: {PSEUDO: function(A, F, E, G) {
...
(function(d) {
    ...
    d.create("tinymce.dom.Selection", {Selection: function(j, i, h) {
            var g = this;
            g.dom = j;
            g.win = i;
            g.serializer = h;
            ...
            if (h.duplicate || h.item) {
                ...
                if (!o) {
                    k.collapse(false);
                    k.insertNode(n.create("span", {"data-mce-type": "bookmark", id: j + "_end", style: v}, m))
                }
                h.collapse(true);
                h.insertNode(n.create("span", {"data-mce-type": "bookmark", id: j + "_start", style: v}, m))
            }
            x.moveToBookmark({id: j, keep: 1});
            return{id: j}
        ...
        function b(m, v) {
            ...
            if (a.isIE6) {
                ...
                if (o.host == r.hostname && o.port == r.port && (o.protocol + ":") == r.protocol && o.protocol.toLowerCase() != "file") {
                    a.util.XHR.send({url: a._addVer(o.getURI()), success: function(z) {
                            var y = q.create("script", {type: "text/javascript"});
                            y.text = z;
...
(function(j) {
    ...
    j.EditorManager = d(j, {editors: [], i18n: {}, activeEditor: null, init: function(x) {
            ...
            x = d({theme: "simple", language: "en"}, x);
            v.settings = x;
...
(function(k) {
    ...
    k.create("tinymce.Editor", {Editor: function(p, o) {
                ...
                i(g(q.plugins), function(u) {
                    if (u && !c.urls[u]) {
                        if (u.charAt(0) == "-") {
                            ...
                            i(s, function(x) {
                                var v = {prefix: "plugins/", resource: x, suffix: "/editor_plugin" + k.suffix + ".js"};
                                x = c.createUrl(v, x);
                                c.load(x.resource, x)
                            })
                        } else {
                            ...
                            c.load(u, {prefix: "plugins/", resource: u, suffix: "/editor_plugin" + k.suffix + ".js"})
                        }
                    }
                });
            ...
            if (G.render_ui && F.theme) {
                ...
                p = F.theme.renderUI({targetNode: B, width: C, height: y, deltaWidth: G.delta_width, deltaHeight: G.delta_height});
            ...
            l.setStyles(p.sizeContainer || p.editorContainer, {width: C, height: y});
            ...
            q = l.add(p.iframeContainer, "iframe", {id: F.id + "_ifr", src: D || 'javascript:""', frameBorder: "0", allowTransparency: "true", title: G.aria_label, style: {width: "100%", height: y, display: "block"}});
            ...
            i(g(o), function(s) {
                var u = {func: m, scope: p || this, desc: n.translate(q), alt: false, ctrl: false, shift: false};
                i(g(s, "+"), function(x) {
                    switch (x) {
                        case"alt":
                        case"ctrl":
...
(function(a) {
    ...
    a.Editor.prototype.bindNativeEvents = function() {
        ...
        k = {mouseup: "onMouseUp", mousedown: "onMouseDown", click: "onClick", keyup: "onKeyUp", keydown: "onKeyDown", keypress: "onKeyPress", submit: "onSubmit", reset: "onReset", contextmenu: "onContextMenu", dblclick: "onDblClick", paste: "onPaste"};
        function e(i, l) {
            var m = i.type;
            if (c.removed) {
                return
...
(function(d) {
    ...
    d.EditorCommands = function(n) {
        ...
        d.extend(this, {execCommand: r, queryCommandState: l, queryCommandValue: h, addCommands: v});
        function f(z, y, x) {
            if (y === b) {
                y = c
            }
        ...
        v({"mceResetDesignMode,mceBeginUndoLevel": function() {
                ...
                F = p.getNode();
                H = {context: F.nodeName.toLowerCase()};
                G = z.parse(L, H);
                B = G.lastChild;
                ...
                n.execCommand("mceInsertContent", false, x.replace(/\{\$selection\}/g, p.getContent({format: "text"})))
        ...
        v({"JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(A) {
        ...
        v({"FontSize,FontName": function(z) {
                var y = 0, x;
...
(function(b) {
    ...
    b.UndoManager = function(h) {
        ...
        l = {data: e, typing: false, onAdd: k, onUndo: j, onRedo: f, beforeChange: function() {
...
(function(a) {
    a.Formatter = function(Z) {
            ...
            function ao(ap) {
                ...
                if (an.split) {
                    ...
                    if (ar != at) {
                        ...
                        ar = R(ar, "span", {id: "_start", "data-mce-type": "bookmark"});
                        at = R(at, "span", {id: "_end", "data-mce-type": "bookmark"});
                        am(ar);
                        am(at);
                        ar = ah(D);
                        at = ah()
                ...
                N.walk(ap, function(au) {
                    S(au, function(av) {
                        ...
                        if (av.nodeType === 1 && Z.dom.getStyle(av, "text-decoration") === "underline" && av.parentNode && i(av.parentNode) === "underline") {
                            Y({deep: false, exact: true, inline: "span", styles: {textDecoration: "underline"}}, null, av)
                        }
                    })
                })
            }
        ...
        a.extend(this, {get: U, register: l, apply: X, remove: C, toggle: G, match: k, matchAll: x, matchNode: z, canApply: A});
        j();
        V();
        function h(aa, ab) {
            if (g(aa, ab.inline)) {
        ...
        function p(aa, al, ad) {
            ...
            return{startContainer: ac, startOffset: ah, endContainer: aq, endOffset: aj}
        }
        ...
        function T(aj, aa, ah) {
            ...
            function ac(an) {
                var am = c.create("span", {id: ak, "data-mce-bogus": true, style: ab ? "color:red" : ""});
                if (an) {
