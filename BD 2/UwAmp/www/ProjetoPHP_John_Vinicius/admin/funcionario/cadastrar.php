    ...
    <div id="conteudo">
        <div id="topo">
            ...
            <marquee OnMouseOut="javascript:this.start()"
                ...
                <h1 class="cabecalho_um"> Cadastro de Funcionario</h1>
            </marquee>
        </div>
        <h1 class="conteudo">
            ...
            <form name="depto" id="depto" method="post" 
                ...
                <br><br>
                Salário<br>
                <input name="txtsalario" id="txtsalario" class="real"
                       type="text">
                <br><br>
                Departamento<br>
...
if (isset($_POST['btn']) && !empty($_POST['txtnome']) && !empty($_POST['txtsalario'])) {
    ...
    for ($i = 0; $i < count($tmp_imagem); $i++) {
        ...
        if (in_array($ext, $extensoes)) {
            ...
            if (move_uploaded_file($tmp_imagem[$i], 
                    "../foto_funcionario/" . $novonome)) {
