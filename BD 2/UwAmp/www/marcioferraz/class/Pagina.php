    ...
    public function mostrar($url, $base) {
        try {
            ...
            if ($linhas = $sqlprep->fetch(PDO::FETCH_NUM)) {
                echo "     
                    <div class='pagina'>
                    <img class='imagemformatada' src = " . $base . "imagem_pagina/$linhas[5] "
                . "alt='" . $linhas[2] . "'/>                    
                        <span class='verticalizar'>
                            <a href='" . $base . "home' title = 'Pagina Principal' >
                                Página Inicial
                            </a> > 
                            <span class = 'aumentar'>$linhas[2]</span>
                        </span>
                    </div>
                    ...
                    <a href='" . $base . "contato' title='Fale Conosco' >
                        <img class='bannerindex' src='imagem/banner.fw.png' alt='banner'>
                    </a>";
            }
        } catch (PDOException $exc) {
            echo $exc->getMessage
