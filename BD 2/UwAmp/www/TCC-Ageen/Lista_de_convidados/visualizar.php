...
<html>
    ...
    <link href="../css/convidado.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Lista de Convidados</h2>
     </div>
     <div class="convidado_main">
     
     <div class="img_do_convidado">
     <img class="img_convidado" src="../imagem/giovana_usuario.jpg">
     </div>
     
       <div id="titulo_do_convidado">
        <h2 class="titulo_do_convidado_text"> Giovanna Januario <h2>
       </div>
       <div id="caixa_descricao_do_convidado"><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id="texto_descricao_descricao">
       <h2 class="descricao_descricao_text"> Descrição <h2>
       </div>
        <div id="texto_descricao_convidado">
       <h2 class="descricao_convidado_text"> Uma pessoa simpatica que adora se divertir...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)92453-6754<h2>
       </div>
     ...
     <div class="img_do_convidado">
     <img class="img_convidado" src="../imagem/vinicius_usuario.jpeg">
     </div>
     
       <div id="titulo_do_convidado">
        <h2 class="titulo_do_convidado_text"> Vinicius Delpino <h2>
       </div>
       <div id="caixa_descricao_do_convidado"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_descricao_text"> Descrição <h2>
        ...
        <div id="texto_descricao_convidado">
       <h2 class="descricao_convidado_text"> Festa?! Opa! Chama que eu vou...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)99803-1389<h2>
       </div>
     ...
     <div class="img_do_convidado">
     <img class="img_convidado" src="../imagem/murillo.jpg">
     </div>
     
       <div id="titulo_do_convidado">
        <h2 class="titulo_do_convidado_text"> Murrillo Raggio <h2>
       </div>
       <div id="caixa_descricao_do_convidado"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_descricao_text"> Descrição <h2>
        ...
        <div id="texto_descricao_convidado">
       <h2 class="descricao_convidado_text"> Estar com os amigos é o melhor...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)99811-3489<h2>
       </div>
