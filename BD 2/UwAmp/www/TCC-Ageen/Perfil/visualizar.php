  ...
  <div id="conteudo">
    ...
    <div id="lado_e"><!-- INICIO LADO ESQUERDO MENU-->
     ...
     <?php
        ...
        $pegaperfil = $con->prepare(" SELECT * from usuario WHERE id_usuario = '$user'");
        $pegaperfil->execute(array($user));
	$dadosperfil = $pegaperfil->fetch();
        
        
    
       $nome_do_usuario = $dadosperfil['nome'];
       $sobrenome_do_usuario = $dadosperfil['sobrenome'];
   ...
   echo "
    <a name='topo'><div id='centro_conteudo'></a>
     ...
     <h2 class='titulo_conteudo_text'>$nome_do_usuario $sobrenome_do_usuario</h2>
     </div>
...
<div class='geral'>
    <div id='site'>
        <div class='contenido'>
            <div id='conteudo_form_perfil'>
                <form name='formnovaconta' method='post'";
        ...
        //obter número de registros retornados
            ...
            if ($num > 0) {
                 ...
                 echo "<a href='#' ><div id='btnalreadyfrineds' class='solicitacaostatus'>Vocês já são amigos</div></a> <a href='../class/actions.php?action=unfrnd&user=$user' ><div id='btnalreadyfrineds' class='solicitacao'>DESFAZER AMIZADE COM $nome_do_usuario $sobrenome_do_usuario</div></a>";
                 
             }else{
                $de_query = "SELECT id FROM frnd_req WHERE de='$user' AND para='$my_id'" ;
                $deprep = $con->prepare($de_query);
                $deprep->execute();
                
                $num_de = $deprep->rowCount();
                
                $para_query = "SELECT id FROM frnd_req WHERE de='$my_id' AND para='$user'";
                $paraprep = $con->prepare($para_query);
                $paraprep->execute();
                $num_para = $paraprep->rowCount();
                
                 if ($num_de > 0) {
               
                    echo "<a href='#' ><div id='btnsolicitationaswer' class='solicitacaostatus'> Nova Solicitação:</div></a> <a href='../class/actions.php?action=noaccept&user=$user'><div id='btnignorar' class='solicitacao'>Ignorar</div></a> <a href='../class/actions.php?action=accept&user=$user'><div id='btnaceitar' class='solicitacao'>Aceitar</div></a>";
                
                    
                }else  if ($num_para > 0) {
                    
                     echo "<a href='../class/actions.php?action=cancel&user=$user'><div id='btncancelarsolicitacao' class='solicitacao'>Cancelar Solicitação de Amizade</div></a>";
                    
                }else{
                    
                    echo "<a href='#' ><div id='btnalreadyfrineds' class='solicitacaostatus'>Vocês ainda não são amigos</div></a>  <a href='../class/actions.php?action=send&user=$user'><div id='btnsolicitacao' class='solicitacao'>Enviar uma Solicitação de Amizade</div></a>";
  ...
  <?php
                       $imagem_user =$dadosperfil['imagem_user'];
                       ?>
                    <div id="imagem_perfil_usuario"><img class="img_perfil_user" src="<?php if ($dadosperfil['imagem_user']==""){ echo "../foto_usuario/usuario.png";}  else{ echo "../foto_usuario/$imagem_user";}?>" alt="foto de perfil"></div>    
                    				

                    <input placeholder="Nome" name="nome" disabled type="text" title="Insira seu Nome aqui" 
                           value="<?php echo $dadosperfil['nome'];?>" size="40" maxlength="50">

                    <input placeholder="Sobrenome" name="sobrenome" disabled type="text"  title="Insira seu Sobrenome aqui" 
                           value="<?php echo $dadosperfil['sobrenome'];?>" size="40" maxlength="50">

                    <input placeholder="N&uacute;mero do celular" name="num_celular" disabled type="text" title="Insira seu celular com DDD e digito 9" 
                           value="<?php echo $dadosperfil['num_celular'];?>" size="40" maxlength="15">
                    ...
                    ?>
                    <select name="dia_nasc" disabled>
                        <option  <?php if ($dadosperfil['dia_nasc'] == "Dia" ) echo 'selected' ; ?> value="Dia">Dia</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 1) echo 'selected' ; ?> value="1">01</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 2) echo 'selected' ; ?> value="2">02</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 3) echo 'selected' ; ?> value="3">03</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 4) echo 'selected' ; ?> value="4">04</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 5) echo 'selected' ; ?> value="5">05</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 6) echo 'selected' ; ?> value="6">06</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 7 ) echo 'selected' ; ?> value="7">07</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 8 ) echo 'selected' ; ?> value="8">08</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 9 ) echo 'selected' ; ?> value="9">09</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 10 ) echo 'selected' ; ?> value="10">10</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 11 ) echo 'selected' ; ?> value="11">11</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 12 ) echo 'selected' ; ?> value="12">12</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 13 ) echo 'selected' ; ?> value="13">13</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 14) echo 'selected' ; ?> value="14">14</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 15 ) echo 'selected' ; ?> value="15">15</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 16 ) echo 'selected' ; ?> value="16">16</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 17 ) echo 'selected' ; ?> value="17">17</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 18 ) echo 'selected' ; ?> value="18">18</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 19 ) echo 'selected' ; ?> value="19">19</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 20 ) echo 'selected' ; ?> value="20">20</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 21 ) echo 'selected' ; ?> value="21">21</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 22 ) echo 'selected' ; ?> value="22">22</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 23 ) echo 'selected' ; ?> value="23">23</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 24 ) echo 'selected' ; ?> value="24">24</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 25 ) echo 'selected' ; ?> value="25">25</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 26 ) echo 'selected' ; ?> value="26">26</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 27 ) echo 'selected' ; ?> value="27">27</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 28 ) echo 'selected' ; ?> value="28">28</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 29 ) echo 'selected' ; ?> value="29">29</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 30 ) echo 'selected' ; ?> value="30">30</option>
                        <option  <?php if ($dadosperfil['dia_nasc'] == 31 ) echo 'selected' ; ?> value="31">31</option>
                   </select>


                    <select name="mes_nasc" disabled  >
                        <option  <?php if ($dadosperfil['mes_nasc'] == "Mes") echo 'selected' ; ?> value="Mes">M&ecirc;s</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 1) echo 'selected' ; ?> value="1">01</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 2) echo 'selected' ; ?> value="2">02</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 3) echo 'selected' ; ?> value="3">03</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 4) echo 'selected' ; ?> value="4">04</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 5) echo 'selected' ; ?> value="5">05</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 6) echo 'selected' ; ?> value="6">06</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 7) echo 'selected' ; ?> value="7">07</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 8) echo 'selected' ; ?> value="8">08</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 9) echo 'selected' ; ?> value="9">09</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 10) echo 'selected' ; ?> value="10">10</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 11) echo 'selected' ; ?> value="11">11</option>
                        <option  <?php if ($dadosperfil['mes_nasc'] == 12) echo 'selected' ; ?> value="12">12</option>

                    </select>


                    <select name="ano_nasc" disabled id="cboanonasc"  >
                        <option  <?php if ($dadosperfil['ano_nasc'] == "Ano") echo 'selected' ; ?> value="Ano">Ano</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1895) echo 'selected' ; ?> value="1895">1895</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1896) echo 'selected' ; ?>  value="1896">1896</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1897) echo 'selected' ; ?>  value="1897">1897</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1898) echo 'selected' ; ?>  value="1898">1898</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1899) echo 'selected' ; ?>  value="1899">1899</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1900) echo 'selected' ; ?>  value="1900">1900</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1901) echo 'selected' ; ?>  value="1901">1901</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1902) echo 'selected' ; ?>  value="1902">1902</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1903) echo 'selected' ; ?>  value="1903">1903</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1904) echo 'selected' ; ?>  value="1904">1904</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1905) echo 'selected' ; ?>  value="1905">1905</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1906) echo 'selected' ; ?>  value="1906">1906</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1907) echo 'selected' ; ?>  value="1907">1907</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1908) echo 'selected' ; ?>  value="1908">1908</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1909) echo 'selected' ; ?>  value="1909">1909</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1910) echo 'selected' ; ?>  value="1910">1910</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1911) echo 'selected' ; ?>  value="1911">1911</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1912) echo 'selected' ; ?>  value="1912">1912</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1913) echo 'selected' ; ?>  value="1913">1913</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1914) echo 'selected' ; ?>  value="1914">1914</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1915) echo 'selected' ; ?>  value="1915">1915</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1916) echo 'selected' ; ?>  value="1916">1916</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1917) echo 'selected' ; ?>  value="1917">1917</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1918) echo 'selected' ; ?>  value="1918">1918</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1919) echo 'selected' ; ?>  value="1919">1919</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1920) echo 'selected' ; ?>  value="1920">1920</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1921) echo 'selected' ; ?>  value="1921">1921</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1922) echo 'selected' ; ?>  value="1922">1922</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1923) echo 'selected' ; ?>  value="1923">1923</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1924) echo 'selected' ; ?>  value="1924">1924</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1925) echo 'selected' ; ?>  value="1925">1925</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1926) echo 'selected' ; ?>  value="1926">1926</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1927) echo 'selected' ; ?>  value="1927">1927</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1928) echo 'selected' ; ?>  value="1928">1928</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1929) echo 'selected' ; ?>  value="1929">1929</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1930) echo 'selected' ; ?>  value="1930">1930</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1931) echo 'selected' ; ?>  value="1931">1931</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1932) echo 'selected' ; ?>  value="1932">1932</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1933) echo 'selected' ; ?>  value="1933">1933</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1934) echo 'selected' ; ?>  value="1934">1934</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1935) echo 'selected' ; ?>  value="1935">1935</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1936) echo 'selected' ; ?>  value="1936">1936</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1937) echo 'selected' ; ?>  value="1937">1937</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1938) echo 'selected' ; ?>  value="1938">1938</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1939) echo 'selected' ; ?>  value="1939">1939</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1940) echo 'selected' ; ?>  value="1940">1940</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1941) echo 'selected' ; ?>  value="1941">1941</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1942) echo 'selected' ; ?>  value="1942">1942</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1943) echo 'selected' ; ?>  value="1943">1943</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1944) echo 'selected' ; ?>  value="1944">1944</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1945) echo 'selected' ; ?>  value="1945">1945</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1946) echo 'selected' ; ?>  value="1946">1946</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1947) echo 'selected' ; ?>  value="1947">1947</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1948) echo 'selected' ; ?>  value="1948">1948</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1949) echo 'selected' ; ?>  value="1949">1949</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1950) echo 'selected' ; ?>  value="1950">1950</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1951) echo 'selected' ; ?>  value="1951">1951</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1952) echo 'selected' ; ?>  value="1952">1952</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1953) echo 'selected' ; ?>  value="1943">1953</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1954) echo 'selected' ; ?>  value="1954">1954</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1955) echo 'selected' ; ?>  value="1955">1955</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1956) echo 'selected' ; ?>  value="1956">1956</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1957) echo 'selected' ; ?>  value="1957">1957</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1958) echo 'selected' ; ?>  value="1958">1958</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1959) echo 'selected' ; ?>  value="1959">1959</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1960) echo 'selected' ; ?>  value="1960">1960</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1961) echo 'selected' ; ?>  value="1961">1961</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1962) echo 'selected' ; ?>  value="1962">1962</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1963) echo 'selected' ; ?>  value="1963">1963</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1964) echo 'selected' ; ?>  value="1964">1964</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1965) echo 'selected' ; ?>  value="1965">1965</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1966) echo 'selected' ; ?>  value="1966">1966</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1967) echo 'selected' ; ?>  value="1967">1967</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1968) echo 'selected' ; ?>  value="1968">1968</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1969) echo 'selected' ; ?>  value="1969">1969</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1970) echo 'selected' ; ?>  value="1970">1970</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1971) echo 'selected' ; ?>  value="1971">1971</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1972) echo 'selected' ; ?>  value="1972">1972</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1973) echo 'selected' ; ?>  value="1973">1973</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1974) echo 'selected' ; ?>  value="1974">1974</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1975) echo 'selected' ; ?>  value="1975">1975</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1976) echo 'selected' ; ?>  value="1976">1976</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1977) echo 'selected' ; ?>  value="1977">1977</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1978) echo 'selected' ; ?>  value="1978">1978</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1979) echo 'selected' ; ?>  value="1979">1979</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1980) echo 'selected' ; ?>  value="1980">1980</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1981) echo 'selected' ; ?>  value="1981">1981</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1982) echo 'selected' ; ?>  value="1982">1982</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1983) echo 'selected' ; ?>  value="1983">1983</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1984) echo 'selected' ; ?>  value="1984">1984</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1985) echo 'selected' ; ?>  value="1985">1985</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1986) echo 'selected' ; ?>  value="1986">1986</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1987) echo 'selected' ; ?>  value="1987">1987</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1988) echo 'selected' ; ?>  value="1988">1988</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1989) echo 'selected' ; ?>  value="1989">1989</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1990) echo 'selected' ; ?>  value="1990">1990</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1991) echo 'selected' ; ?>  value="1991">1991</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1992) echo 'selected' ; ?>  value="1992">1992</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1993) echo 'selected' ; ?>  value="1993">1993</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1994) echo 'selected' ; ?>  value="1994">1994</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1995) echo 'selected' ; ?>  value="1995">1995</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1996) echo 'selected' ; ?>  value="1996">1996</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1997) echo 'selected' ; ?>  value="1997">1997</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1998) echo 'selected' ; ?>  value="1998">1998</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 1999) echo 'selected' ; ?>  value="1999">1999</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2000) echo 'selected' ; ?>  value="2000">2000</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2001) echo 'selected' ; ?>  value="2001">2001</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2002) echo 'selected' ; ?>  value="2002">2002</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2003) echo 'selected' ; ?>  value="2003">2003</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2004) echo 'selected' ; ?>  value="2004">2004</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2005) echo 'selected' ; ?>  value="2005">2005</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2006) echo 'selected' ; ?>  value="2006">2006</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2007) echo 'selected' ; ?>  value="2007">2007</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2009) echo 'selected' ; ?>  value="2009">2009</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2010) echo 'selected' ; ?>  value="2010">2010</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2011) echo 'selected' ; ?>  value="2011">2011</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2012) echo 'selected' ; ?>  value="2012">2012</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2013) echo 'selected' ; ?>  value="2013">2013</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2014) echo 'selected' ; ?>  value="2014">2014</option>
                        <option  <?php if ($dadosperfil['ano_nasc'] == 2015) echo 'selected' ; ?>  value="2015">2015</option>
...
<br>
                    ...
                    <input name="sexo" <?php if ($dadosperfil['sexo'] == "Feminino" ) echo 'checked' ; ?> disabled value="Feminino"  type="RADIO"> Feminino  &nbsp; &nbsp;
                    <input name="sexo" <?php if ($dadosperfil['sexo'] == "Masculino" ) echo 'checked' ; ?> disabled value="Masculino"   type="RADIO"> Masculino <br>
 		...
 		<input name="tipo" <?php if ($dadosperfil['empresa'] == "Sim" ) echo 'checked' ; ?> disabled value="Sim"  type="RADIO"> Sim  &nbsp; &nbsp;
                <input name="tipo" <?php if ($dadosperfil['empresa'] == "Nao" ) echo 'checked' ; ?> disabled value="Nao"   type="RADIO"> Não <br>
                   </div>
...
<?php
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text"> Perfil </h2>
     </div>
     <div class="perfil_main">
...
<br>
                    ...
                    <input name="sexo" <?php if ($dadosUser['sexo'] == "Feminino" ) echo 'checked' ; ?> disabled value="Feminino"  type="RADIO"> Feminino  &nbsp; &nbsp;
                    <input name="sexo" <?php if ($dadosUser['sexo'] == "Masculino" ) echo 'checked' ; ?> disabled value="Masculino"   type="RADIO"> Masculino <br>
                    <div id="texto_empresa"><h2 class="empresa_text">Empresa</h2></div>
                    <br>
                    <br>
                    <br>
                   ...
                   <div id="tipo_pessoa_empresa">
 		<input name="tipo" <?php if ($dadosUser['empresa'] == "Sim" ) echo 'checked' ; ?> disabled value="Sim"  type="RADIO"> Sim  &nbsp; &nbsp;
                <input name="tipo" <?php if ($dadosUser['empresa'] == "Nao" ) echo 'checked' ; ?> disabled value="Nao"   type="RADIO"> Não <br>
                   </div>
