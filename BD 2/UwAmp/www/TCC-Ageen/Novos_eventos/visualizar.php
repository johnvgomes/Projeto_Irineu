...
<html>
	...
	<link href="../css/novos_eventos.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Novos Eventos</h2>
     </div>
...
<div class="geral">
    <div id="site">
        <div class="contenido">
            <div id="conteudo_form_perfil">
                <form name="formnovaconta" method="post" action="">
                    ...
                    <div id="imagem_perfil_usuario"><img class="img_perfil_user" src="../imagem/ICON CHECKIT/icones_simples/freeiconmaker_74.png"></div>    
  					<input class="btn_imagem" type="file" name="arquivo" id="arquivo"  value="mateus viado"  />
   					 <br> 
    				...
    				<h2 class="descricao_titulo_text">Descrição</h2>
   					</div>
                    ...
                    <select name="ano_nasc" id="cboanonasc"  >
                     ...
                     <option value="LOCAIS">LOCAIS</option>
                            ...
                            ?>
                             ...
                             <input placeholder="Telefone" name="num_celular" type="text" title="Insira seu celular com DDD e digito 9" 
                           value="" size="40" maxlength="15">
                                 
                                 <div class="mais_titulo">
    				<h2 class="mais_titulo_text">Mais</h2>
   					</div>
                    ...
                    <select name="entretenimento">
                     <option value="ENTRETENIMENTO">ENTRETENIMENTOS</option>
                            <?php
                            ...
                            ?>
                                 ...
                                 <div class="mais_titulo">
    				<h2 class="mais_titulo_text">Convidar</h2>
   					</div>
        ...
        <div id="campo_mais_convidado" >
        
		<img href="javascript:custom;" onMouseDown="toggleDiv('minha-div-1');" id="imagem" class="img_mais_convidado" 
        alt="favorito.jpg" src="../imagem/favoritocinza.png" onClick="troca( this, 'imagem2' )" /></a>
                   ...
                   <div id="tipo_pessoa_empresa">
 					<input name="tipo" value="Sim"  type="RADIO"> Sim  &nbsp; &nbsp;
                    <input name="tipo" value="Não"   type="RADIO"> Não <br>
                   </div>
