...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Locais</h2>
     </div>
     <?php
      include_once '../class/Conectar.php';
        //instancia Conectar
        $con = new Conectar();
         ...
         $descricao=$vetor[2];
         $telefone=$vetor[3];
             echo "<div class='local_main'> 
                 <div class='img_do_local'>
        
       <img class='img_local' src='../foto_local/$logomarca' alt='$logomarca' />
         
   
     </div>
     
       <div id='titulo_do_local'>
        <h2 class='titulo_do_local_text'>$nome_user<h2>
       </div>
       <div id='caixa_descricao_do_local'><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class='descricao_local_text'>$descricao </h2>
       </div>
