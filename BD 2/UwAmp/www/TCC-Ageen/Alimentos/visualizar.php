...
<html>
    ...
    <link href="../css/alimento.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <div id="lado_e"><!-- INICIO LADO ESQUERDO MENU-->
     ...
     <h2 class="titulo_conteudo_text">Alimentos</h2>
     </div>
      <?php
      include_once '../class/Conectar.php';
        //instancia Conectar
        $con = new Conectar();
         ...
         $descricao=$vetor[2];
         $telefone=$vetor[3];
             echo "<div class='alimento_main'> 
                 <div class='img_do_alimento'>
        
       <img class='img_aliment' src='../foto_alimento/$logomarca' alt='$logomarca' />
         
   
     </div>
     
       <div id='titulo_do_alimento'>
        <h2 class='titulo_do_alimento_text'>$nome_user<h2>
       </div>
       <div id='caixa_descricao_do_alimento'><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id='texto_descricao_descricao'>
       <h2 class='descricao_descricao_text'> Descrição </h2>
       </div>
        <div id='texto_descricao_alimento'>
       <h2 class='descricao_alimento_text'>$descricao </h2>
       </div>
