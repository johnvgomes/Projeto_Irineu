...
<html>
    ...
    <link href="../css/musica.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Musicas</h2>
     </div>
      ...
      include_once '../class/Conectar.php';
        ...
        $con = new Conectar();
         ...
         $descricao=$vetor[2];
         $telefone=$vetor[3];
             echo "<div class='musica_main'> 
                 <div class='img_da_musica'>
        
       <img class='img_musica' src='../foto_musica/$logomarca' alt='$logomarca' />
         
   
     </div>
     
       <div id='titulo_da_musica'>
        <h2 class='titulo_da_musica_text'>$nome_user<h2>
       </div>
       <div id='caixa_descricao_da_musica'><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id='texto_descricao_descricao'>
       <h2 class='descricao_descricao_text'> Descrição </h2>
       </div>
        <div id='texto_descricao_musica'>
       <h2 class='descricao_musica_text'>$descricao </h2>
       </div>
