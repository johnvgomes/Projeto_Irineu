...
<html>
    ...
    <link href="../css/adicionar_amigos.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <div id="lado_e"><!-- INICIO LADO ESQUERDO MENU-->
      ...
      <div id="caixa_pesquisa">
        ...
        <form>
          ...
          <input type="text" name="pesquisar" class="pesquisa" placeholder="O que você procura?">
        </form>
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Adicionar Amigos</h2>
     </div>
     
       <div id="caixa_pesquisa_amigos">
         
           <form method="post">
            <input name="searchfriend" type="submit" id="Enviar" class='searchbtn_amigos' value=""/>
          <input type="text" name="pesquisafriend" class="pesquisa_amigos" placeholder="O que você procura?">
        </form>
        ...
        $con = new Conectar();
         ...
         try{
             if(isset($_POST['searchfriend'])){
                 ...
                 if(
                    $_POST['pesquisafriend']== "e"       || $_POST['pesquisafriend']== "E" ||
                    $_POST['pesquisafriend']== "em"      || $_POST['pesquisafriend']== "EM" ||
                    $_POST['pesquisafriend']== "emp"     || $_POST['pesquisafriend']== "EMP" ||
                    $_POST['pesquisafriend']== "empr"    || $_POST['pesquisafriend']== "EMPR" ||
                    $_POST['pesquisafriend']== "empre"   || $_POST['pesquisafriend']== "EMPRE" ||
                    $_POST['pesquisafriend']== "empres"  || $_POST['pesquisafriend']== "EMPRES" ||
                    $_POST['pesquisafriend']== "empresa" || $_POST['pesquisafriend']== "EMPRESA" )
                    ...
                    $_POST['pesquisafriend']== "p"      || $_POST['pesquisafriend']== "P" ||
                    $_POST['pesquisafriend']== "pe"     || $_POST['pesquisafriend']== "PE" ||
                    $_POST['pesquisafriend']== "pes"    || $_POST['pesquisafriend']== "PES" ||
                    $_POST['pesquisafriend']== "pess"   || $_POST['pesquisafriend']== "PESS" ||
                    $_POST['pesquisafriend']== "pesso"  || $_POST['pesquisafriend']== "PESSO" ||
                    $_POST['pesquisafriend']== "pessoa" || $_POST['pesquisafriend']== "PESSOA")
                 {
    ...
    extract($_POST, EXTR_OVERWRITE);
               $sql = "SELECT * FROM `usuario` WHERE `nome` LIKE '".$_POST['pesquisafriend']."%' OR `sobrenome` LIKE '".$_POST['pesquisafriend']."%' OR `uf` LIKE '".$_POST['pesquisafriend']."%' OR `cidade` LIKE '".$_POST['pesquisafriend']."%' OR `num_celular` LIKE '".$_POST['pesquisafriend']."%' OR `empresa` LIKE '".$tipo_user."%' ORDER BY `nome`" ;         
             
                }else{
        $sql = "SELECT * FROM usuario WHERE id_usuario!='".$dadosUser['id_usuario']."' ORDER BY nome";
         }
            $sqlprep = $con->query($sql);
        ...
        if($vetor[14]=="Sim")
         ...
         if ($vetor[2]==""){ 
             ...
             $local_da_imagem= "../foto_usuario/usuario.png";
             $img_user = "usuario.png";
             }
             else{ 
                 
                $local_da_imagem = "../foto_usuario/$img_user";
                 
                 
             }
                
         
             echo "<a href='../Perfil/visualizar.php?user=$user_id' style='display:block'>
                 <div class='adicionar_amigos_main'> 
                 <div class='img_do_adicionar_amigos'>
        
       <img class='img_adicionar_amigos' src='$local_da_imagem' alt='$img_user' />
         
  
     </div>
     
       <div id='titulo_do_adicionar_amigos'>
        <h2 class='titulo_do_adicionar_amigos_text'>$nome_user $sobrenome_user<h2>
       </div>
       <div id='caixa_descricao_do_adicionar_amigos'><!-- INICIO CAIXA DESCRICAO-->
        
               <div id='texto_descricao_tipo'>
       <h2 class='descricao_tipo_text'> $tipodeusuario </h2>
       </div>
        <div id='texto_descricao_local'>
       <h2 class='descricao_local_text'>$cidade </h2>
       </div>
      
        <div id='texto_descricao_telefone'>
       <h2 class='descricao_telefone_text'> $num_celular</h2>
       </div>
