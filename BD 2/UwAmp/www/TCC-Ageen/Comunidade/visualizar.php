...
<html>
    ...
    <link href="../css/comunidade.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Comunidades</h2>
     </div>
     <?php
      include_once '../class/Conectar.php';
        //instancia Conectar
        $con = new Conectar();
         ...
         $descricao=$vetor[2];
         $telefone=$vetor[3];
             echo "<div class='comunidade_main'> 
                 <div class='img_da_comunidade'>
        
       <img class='img_comunidade' src='../foto_comunidade/$logomarca' alt='$logomarca' />
         
   
     </div>
     
       <div id='titulo_da_comunidade'>
        <h2 class='titulo_da_comunidade_text'>$nome_user<h2>
       </div>
       <div id='caixa_descricao_da_comunidade'><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id='texto_descricao_descricao'>
       <h2 class='descricao_descricao_text'> Descrição </h2>
       </div>
        <div id='texto_descricao_comunidade'>
       <h2 class='descricao_comunidade_text'>$descricao </h2>
       </div>
      
        <div id='texto_descricao_telefone'>
       <h2 class='descricao_telefone_text'> $telefone</h2>
       </div>
