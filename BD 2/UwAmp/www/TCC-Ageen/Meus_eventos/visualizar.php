...
<html>
    ...
    <link href="../css/meus_eventos.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Meus Eventos</h2>
     </div>
          <div class="meus_eventos_main">
     
     <div class="img_do_meus_eventos">
     <img class="img_meus_eventos" src="../imagem/tcc.jpg">
     </div>
     
       <div id="titulo_do_meus_eventos">
        <h2 class="titulo_do_meus_eventos_text"> TCC 3TI <h2>
       </div>
       <div id="caixa_descricao_do_meus_eventos"><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id="texto_descricao_descricao">
       <h2 class="descricao_descricao_text"> Descrição <h2>
       </div>
        <div id="texto_descricao_meus_eventos">
       <h2 class="descricao_meus_eventos_text"> Apresentação, e demonstraçao dos TCC's...  <h2>
       </div>
      
        <div id="texto_descricao_data">
       <h2 class="descricao_data_text"> Data: 07/12/2015 <h2>
       </div>
     ...
     <div class="img_do_meus_eventos">
     <img class="img_meus_eventos" src="../imagem/chacara_para_venda_em_uberaba_mg_no_bairro_chacaras_villa_real_5420098438981667071.jpg">
     </div>
     
       <div id="titulo_do_meus_eventos">
        <h2 class="titulo_do_meus_eventos_text"> Chacara Fim de Ano <h2>
       </div>
       <div id="caixa_descricao_do_meus_eventos"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_descricao_text"> Descrição <h2>
        ...
        <div id="texto_descricao_meus_eventos">
       <h2 class="descricao_meus_eventos_text"> Comemoração Fim de ano do 3TI...  <h2>
       </div>
      
        <div id="texto_descricao_data">
       <h2 class="descricao_data_text"> Data: 04/12/2015 à 06/12/2015  <h2>
       </div>
     ...
     <div class="img_do_meus_eventos">
     <img class="img_meus_eventos" src="../imagem/evento-brasil-game-show-1560x950_c.jpg">
     </div>
     
       <div id="titulo_do_meus_eventos">
        <h2 class="titulo_do_meus_eventos_text"> BGS-2016 <h2>
       </div>
       <div id="caixa_descricao_do_meus_eventos"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_descricao_text"> Descrição <h2>
        ...
        <div id="texto_descricao_meus_eventos">
       <h2 class="descricao_meus_eventos_text"> Brasil Game show...  <h2>
       </div>
      
        <div id="texto_descricao_data">
       <h2 class="descricao_data_text"> Data: 22/10/2016 <h2>
       </div>
