...
class Paginar {
    ...
    public function paginacao($numreg, $pg, $table1, $table2, $pasta, $link, $imagem, $nome, $url, $salario, $class) {
        ...
        try {
            ...
            WHERE $table1.id = $table2.id_funcionario
            GROUP BY $table1.id
            ...
            while ($linha = $result->fetch(PDO::FETCH_NUM)) {
                ...
                . "<br><span>Salário: R$ "
                . number_format($linha[$salario], 2, ',', '.')
                . "</span>"
                . " <br><a href = '" . $this->url->getBase() . "visualizar/" . $linha[$url] . "' > "
                . "visualizar ficha"
                . " </a>"
                . " </article>";
                $i++;
