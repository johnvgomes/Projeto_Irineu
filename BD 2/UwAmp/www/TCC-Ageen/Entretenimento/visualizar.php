...
<html>
    ...
    <link href="../css/entretenimento.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Entretenimento</h2>
     </div>
     <div class="entretenimento_main">
     
     <div class="img_do_entretenimento">
     <img class="img_entretenimento" src="../imagem/os-barbixas.jpg">
     </div>
     
       <div id="titulo_do_entretenimento">
        <h2 class="titulo_do_entretenimento_text"> Os Barbixas <h2>
       </div>
       <div id="caixa_descricao_do_entretenimento"><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id="texto_descricao_descricao">
       <h2 class="descricao_descricao_text"> Descrição <h2>
       </div>
        <div id="texto_descricao_entretenimento">
       <h2 class="descricao_entretenimento_text"> Humor, risadas, e muita diversão...  <h2>
       </div>
     ...
     <div class="img_do_entretenimento">
     <img class="img_entretenimento" src="../imagem/magico.jpg">
     </div>
     
       <div id="titulo_do_entretenimento">
        <h2 class="titulo_do_entretenimento_text"> Magico <h2>
       </div>
       <div id="caixa_descricao_do_entretenimento"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_descricao_text"> Descrição <h2>
        ...
        <div id="texto_descricao_entretenimento">
       <h2 class="descricao_entretenimento_text"> Magica, Surpresas, e muito mais...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)99021-2345<h2>
       </div>
     ...
     <div class="img_do_entretenimento">
     <img class="img_entretenimento" src="../imagem/palhaço.jpg">
     </div>
     
       <div id="titulo_do_entretenimento">
        <h2 class="titulo_do_entretenimento_text"> Palhaço <h2>
       </div>
       <div id="caixa_descricao_do_entretenimento"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_descricao_text"> Descrição <h2>
        ...
        <div id="texto_descricao_entretenimento">
       <h2 class="descricao_entretenimento_text"> Risadas, brincadeiras...  <h2>
       </div>
      
        <div id="texto_descricao_telefone">
       <h2 class="descricao_telefone_text"> Telefone: (11)97654-2945<h2>
       </div>
