...
<html>
    ...
    <link href="../css/meus_grupos.css" type="text/css" rel="stylesheet">
...
<div id="tudo">
  ...
  <div id="conteudo">
    ...
    <a name="topo"><div id="centro_conteudo"></a>
     ...
     <h2 class="titulo_conteudo_text">Meus Grupos</h2>
     </div>
          <div class="meus_grupos_main">
     
     <div class="img_do_meus_grupos">
     <img class="img_meus_grupos" src="../imagem/TI_grupo.jpg">
     </div>
     
       <div id="titulo_do_meus_grupos">
        <h2 class="titulo_do_meus_grupos_text"> Escola 3TI <h2>
       </div>
       <div id="caixa_descricao_do_meus_grupos"><!-- INICIO CAIXA DESCRICAO-->
        
        
         <div id="texto_descricao_sobre">
       <h2 class="descricao_sobre_text"> Sobre <h2>
       </div>
       <div id="texto_descricao_tipo">
       <h2 class="descricao_tipo_text"> Fechado <h2>
       </div>
        <div id="texto_descricao_meus_grupos">
       <h2 class="descricao_meus_grupos_text"> Amigos da ETEC Martinho Di Ciero...  <h2>
       </div>
      
        <div id="texto_descricao_estilo">
       <h2 class="descricao_estilo_text"> Informal <h2>
       </div>
        
        <div id="texto_descricao_idade_recomendada">
       <h2 class="descricao_idade_recomendada_text"> Idade Recomendada: 16 <h2>
       </div>
     ...
     <div class="img_do_meus_grupos">
     <img class="img_meus_grupos" src="../imagem/futebol.jpg">
     </div>
     
       <div id="titulo_do_meus_grupos">
        <h2 class="titulo_do_meus_grupos_text"> Futebol <h2>
       </div>
       <div id="caixa_descricao_do_meus_grupos"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_tipo_text"> Fechado <h2>
        ...
        <div id="texto_descricao_meus_grupos">
       <h2 class="descricao_meus_grupos_text"> Rumo ao Hexa...  <h2>
       </div>
     ...
     <div class="img_do_meus_grupos">
     <img class="img_meus_grupos" src="../imagem/familia.jpg">
     </div>
     
       <div id="titulo_do_meus_grupos">
        <h2 class="titulo_do_meus_grupos_text"> Familia <h2>
       </div>
       <div id="caixa_descricao_do_meus_grupos"><!-- INICIO CAIXA DESCRICAO-->
       ...
       <h2 class="descricao_tipo_text"> Fechado <h2>
        ...
        <div id="texto_descricao_meus_grupos">
       <h2 class="descricao_meus_grupos_text"> Familia e amigos...  <h2>
       </div>
