...
class Curso extends Entity{
    ...
    public function mostrar($id,$tipo){
        ...
        while ($linhas = mysql_fetch_row($sql)){
            ...
            <tr><td><img src='".$curso."imagem/".$linhas[5]."' alt='".$linhas[1]."' width='500px' height='150px' /></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td><strong>Informa&ccedil;&otilde;es Gerais: </strong></td></tr>
            <tr><td>".$linhas[2]."<br /></td></tr>
            <tr><td><strong>Matriz Curricular</strong> - <a href='".$curso."matriz/".$linhas[3]."' target='_blank' title='".$linhas[1]."'>Clique aqui</a></td></tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td><strong>Plano de Curso</strong> - <a href='".$curso."plano/".$linhas[4]."' target='_blank' title='".$linhas[1]."'>Clique aqui</a></td></tr>
            ";
        }
        echo "</table>";
    }
