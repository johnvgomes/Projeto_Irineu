...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".mencao").click(function(){
			...
			var url = "alterar_mencao.php?codEtapa=<?php echo $codEtapa?>&codDisciplina="+disciplina+"&codaluno=<?php echo $codAluno;?>&codTurma=<?php echo $codTurma;?>&nChamada=<?php echo $nChamada;?>&retorno=2";
...
<table class="table table-hover">
	...
	while ($disciplina = mysql_fetch_array($rsDisciplinas)) { 
		...
		if ($mencaoIntermediaria=='I' || $mencaoFinal=="I"){
		...
		if ($mencaoIntermediaria=='I' || $mencaoFinal=="I"){
			echo "<a href='editar_deliberacao.php?codMatricula=$codMatricula&codDisciplina=$codDisciplina' class='ui-icon ui-icon-comment'></a>";
		}	
		echo "</td></tr>";
	 } 
