...
if ($_GET["confirm"]==1){
	$mi = $_GET["mi"];
	$mf = $_GET["mf"];
		$sql = "UPDATE Mencoes SET mencaoIntermediaria='$mi', mencaoFinal='$mf' 
	...
	$rs = mysql_query($sql);
	if ($rs){
		header("Location: conselho_final.php?codturma=$codTurma&nchamada=$nChamada");
	}else{
...
<body>
	...
	<form>
	  <fieldset>
	    ...
	    <a href="<?php echo 'conselho_final.php?codturma='.$codTurma.'&nchamada='.$nChamada;?>" class="btn btn-large">Cancelar</a>
	  </fieldset>
	</form>
