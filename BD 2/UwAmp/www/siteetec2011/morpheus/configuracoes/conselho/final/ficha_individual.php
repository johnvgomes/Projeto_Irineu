...
while ($aluno = mysql_fetch_array($rsAlunos)){
	...
	<link rel="stylesheet" href="style_ficha_individual.css">
	...
	<div class="centro"><img src="../ata/logoPaulaSouza.png"></div>
	<div class="boxTitulo">FICHA INDIVIDUAL DO ALUNO</div>
	...
	<?php
		...
		//para informática busca do diário
		if ($codCurso==8){
						$sqlTotalFaltas = "SELECT count(codChamada) as faltas FROM Faltas
