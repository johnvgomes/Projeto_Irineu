...
<table>
    <tr>
      <td><h3>Deseja excluir este Cadastro do EPA?</h3></td>
    </tr>
    <tr>
        <td>
...
<?php
    if (isset($_POST['enviar'])){
        ...
        if($_POST['decisao'] == "s"){
            ...
            $e->excluir($id);
            header("Location:?p=cadastro/consultar.php");
            echo '<meta http-equiv="refresh" content="1;URL=?p=cadastro/consultar.php">';
        }else{
            header("Location:?p=cadastro/consultar.php");
            echo '<meta http-equiv="refresh" content="1;URL=?p=cadastro/consultar.php">';
        }
