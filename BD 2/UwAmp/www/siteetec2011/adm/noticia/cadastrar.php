...
<table>
    <tr>
        <td colspan="2"><h3>Formulário de Cadastro de Not&iacute;cia</h3></td>
    </tr>
    <tr>
        <td>T&iacute;tulo:</td>
        <td>
    ...
    <tr>
        <td>Legenda:</td>
        <td>
            <input name="txtlegenda" type="text" id="txtlegenda" size="50" maxlength="70" />
        </td>
    </tr>
    <tr>
...
if(isset($_POST['cadastrar']) && !empty($_POST['txttitulo']) && !empty($_POST['txtconteudo'])){
    ...
    $n = new Noticia($_POST['txttitulo'], $_POST['txtconteudo']
            , date("d/m/Y"),
