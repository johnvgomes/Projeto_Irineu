...
<table>
    <tr>
        <td colspan="2"><h3>Editar Curso</h3></td>
    </tr>
    <tr>
        <td>Nome:</td>
        <td>
    ...
    <tr>
        ...
        <td>
            <textarea name="txtdescricao" id="text" cols="50" rows="20"><?php echo $array[2]; ?></textarea>
        </td>
    </tr>
    <tr>
        <td colspan="2">
...
<?php
    if (isset($_POST['cadastrar'])){
        $c->editar($id,$_POST['txtnome'],$_POST['txtdescricao']);
