...
class Paginar {
    ...
    public function paginacao($numreg, $pg, $table1, $table2, $pasta, $px, $link, $imagem, $titulo, $conteudo, $url, $data) {
        ...
        try {
            ...
            WHERE $table1.id = $table2.id_noticia
            GROUP BY $table1.id
            ...
            while ($linha = $result->fetch(PDO::FETCH_NUM)) {
                ...
                . "<a href='" . $this->url->getBase() . "visualizar/" . $linha[$url] . "'>"
                . "Para visualizar, clique aqui!</a>"
                . "</div>";
            }
            echo "<div class='central'><div class='numeracao'>";
            $this->montarNumeracao($table1, $pg, $numreg, $link);
            echo "</div></div>";
