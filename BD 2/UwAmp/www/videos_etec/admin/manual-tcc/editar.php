...
if (!isset($_SESSION['sessao'])) {
    ...
    $vetor = $a->carregar($id,"manual_tcc");
    echo "<br>";
    //passar a table abaixo
    echo $a->consultar("manual_tcc");
    echo "<br><br>";
    ?>
    ...
    <table>
        <form method="post" 
            ...
            <tr>
                <td>
                    <h3>Trocar arquivo do Manual do TCC (somente PDF)</h3>
                </td>
            </tr>
    ...
    if (isset($_POST['btnenviar'])) {
        ...
        if (in_array($ext, $extensoes)) {
            ...
            $a->editarArquivo($id, $newnome . $ext, $temporario, $vetor[1],
                    "../manual-tcc/","manual_tcc","arquivo");
            
        }



        echo "<script language='javaScript'>window.location.href='?p=manual-tcc/editar'</script>";
    }
}
?>
