...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fly",prev:"",next:"",duration:20*100,delay:40*100,width:1200,height:400,autoPlay:true,playPause:true,stopOnHover:false,loop:false,bullets:false,caption:false,captionEffect:"slide",controls:true,onBeforeStep:0,images:0});